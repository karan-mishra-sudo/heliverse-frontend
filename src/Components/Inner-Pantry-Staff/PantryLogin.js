...
import { loginPantryStaff } from "../Redux-thunk/Actions/loginPantryStaff"
...
export default function PantryLogin() {
  ...
  function loginProcess(params) {
    ...
    let res = dispatch(loginPantryStaff(payload));
    res.then((res)=>{
      if(res)
      {
      ...
      <div className="relative px-4 py-10 bg-black mx-8 md:mx-0 shadow rounded-3xl sm:p-10">
        <div className="max-w-md mx-auto text-white">
          <div className="flex items-center justify-center">
            <h1 className="font-extrabold text-2xl">Pantry Login</h1>
          </div>
