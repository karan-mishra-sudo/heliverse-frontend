...
const NAVIGATION = [
  ...
  },
  {
    ...
    title: "Create food/diet charts for patients",
    icon: (
  ...
  {
    segment: "files",
    title: "Manage inner pantry",
    icon: <InsertDriveFileIcon />,
  },
  {
    segment: "settings",
    title: "Track meal preparation and delivery",
    icon: <SettingsIcon />,
  },
  {
    segment: "profile",
...
function FoodManagerDashboard(props) {
  const { window } = props;
