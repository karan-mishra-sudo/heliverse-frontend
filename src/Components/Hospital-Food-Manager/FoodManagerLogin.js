...
import {loginFoodManager} from "../Redux-thunk/Actions/loginFoodManager"
import { useNavigate } from "react-router-dom";
export default function FoodManagerLogin() {
  ...
  function loginProcess(params) {
    ...
    let res= dispatch(loginFoodManager(payload));
    res.then((res)=>{
      if(res)
      {
        navigate("/Dashboard-FoodManager");
      }
    })
  }
  return (

    <div className="relative py-3 sm:max-w-xl sm:mx-auto w-full flex justify-center items-center">
      <div className="relative px-4 py-10 bg-black mx-8 md:mx-0 shadow rounded-3xl sm:p-10">
        <div className="max-w-md mx-auto text-white">
          <div className="flex items-center justify-center">
            <h1 className="font-extrabold text-2xl">Food Manager</h1>
          </div>
            ...
            <div>
              <button className="flex items-center justify-center py-2 px-20 bg-white hover:bg-gray-200 focus:ring-blue-500 focus:ring-offset-blue-200 text-gray-700 w-full transition ease-in duration-200 text-center text-base font-semibold shadow-md focus:outline-none focus:ring-2 focus:ring-offset-2 rounded-lg">
                ...
                >
                  ...
                  >
                    <stop stopOpacity=".2" stop-color="#fff" offset="0"></stop>
                    <stop stopOpacity="0" stop-color="#fff" offset="1"></stop>
                  </linearGradient>
                  <path
